...
module.exports = {
    ...
    CLIST_MSG: process.env.COMMAND_LIST_MSG === undefined ? '*You need to set COMMAND_CLIST_MSG!* 🔧' : process.env.COMMAND_LIST_MSG,
    ...
    NEW_SESSION: process.env._NEW_SESSON === undefined ? 'false' : process.env._NEW_SESSION,
    BRANCH: 'multi-device',
    HEROKU: {
    ...
    DATABASE: DATABASE_URL === './alphaX.db' ? new Sequelize({
        dialect: "sqlite",
